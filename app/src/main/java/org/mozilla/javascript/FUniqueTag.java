 ...
 */
public final class FUniqueTag implements Serializable
{
     ...
     */
    public static final FUniqueTag
        NOT_FOUND = new FUniqueTag(ID_NOT_FOUND);

    /**
     * Tag to distinguish between uninitialized and null values.
     */
    public static final FUniqueTag
        NULL_VALUE = new FUniqueTag(ID_NULL_VALUE);
     ...
     */
    public static final FUniqueTag
        DOUBLE_MARK = new FUniqueTag(ID_DOUBLE_MARK);

    private final int tagId;

    private FUniqueTag(int tagId)
    {
        this.tagId = tagId;
    }
