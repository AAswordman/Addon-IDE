...
public class 字符工具 {
    ...
    public static int 汉字转成ASCII码(String chs) {
        int asc = 0;
        try {
    ...
    public static String 单字解析(String str) {
        String result = null;
        int ascii = 汉字转成ASCII码(str);
    ...
    public static String 替换null(String str) {
    ...
    public static boolean 是否是空字符串(String str) {
        return str == null || str.trim().length() == 0;
    }

    public static int 中文长度(String str) {
        int valueLength = 0;
        String chinese = "[\u0391-\uFFE5]";
        if (!是否是空字符串(str)) {
    ...
    public static int 字符串长度(String str) {
        int valueLength = 0;
        String chinese = "[\u0391-\uFFE5]";
        if (!是否是空字符串(str)) {
            for (int i = 0; i < str.length(); i++) {
    ...
    public static int 获取指定长度的字符所在位置(String str, int maxL) {
        int currentIndex = 0;
        int valueLength = 0;
        String chinese = "[\u0391-\uFFE5]";
        for (int i = 0; i < str.length(); i++) {
    ...
    public static Boolean 是否是中文(String str) {
    ...
    public static Boolean 是否包含中文(String str) {
    ...
    public static String 不足2位前面补0(String str) {
        try {
            if (str.length() <= 1) {
                str = "0" + str;
            }
    ...
    public static int 类型安全转换(Object value, int defaultValue) {
    ...
    public static String 指定小数输出(String s, String format) {
