...
public class 验证工具 {
    public static boolean 判断姓名格式(String value) {
        String regex = "^([\\u4e00-\\u9fa5]+|([a-zA-Z]+\\s?)+)$";
        return 是否匹配正则(regex, value);
    }

    public static boolean 判断手机号格式(String value) {
        String regex = "^(\\+?\\d{2}-?)?(1[0-9])\\d{9}$";
        return 是否匹配正则(regex, value);
    }

    public static boolean  判断账号格式(String value) {
        String regex = "[\\u4e00-\\u9fa5a-zA-Z0-9\\-]{4,20}";
        return 是否匹配正则(regex, value);
    }

    public static boolean 判断密码格式(String value) {
        String regex = "^[a-zA-Z0-9]{6,12}$";
        return 是否匹配正则(regex, value);
    }

    public static boolean 判断字母密码格式(String value) {
        String regex = "(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,}";
        return 是否匹配正则(regex, value);
    }


    public static boolean 判断邮箱格式(String value) {
...
//        return testRegex(regex, value);
    ...
    public static boolean 是否数值型(String input) {
    ...
    public static boolean 是否匹配正则(String regex, String inputValue) {
        return Pattern.compile(regex).matcher(inputValue).matches();
    }

    public static boolean 匹配中国邮政编码(String postcode) {
