...
public class GrammarCheck {
    ...
    public static class ShowError extends Exception {
        ...
        public int point;
<<<<<<< HEAD
        public int visualChar;
        private String msg;

        public ShowError(int line, int point,int visualChar) {
            this.line = line;
...
<<<<<<< HEAD
                                    throw new ShowError(index, row,visualChar).setMessage("当前所需要状态:" + shouldState);
=======
...
<<<<<<< HEAD
                                                throw new ShowError(index, row,visualChar).setMessage("错误使用','");
=======
...
<<<<<<< HEAD
                                    if (systemList.size() - 1 < 0)throw new ShowError(index, row,visualChar).setMessage("多出的'}'符号，无法和前面配对" + shouldState + ",当前system" + system);
=======
                        ...
                        case FLAG_ARRE:{
                            if (shouldState != CODE_K && shouldState != CODE_V_S) {
                                if ((shouldState == CODE_V_to_N || shouldState == CODE_F_V || shouldState == CODE_V_I || shouldState == CODE_V_D) 
                                    ...
                                    systemList.remove(systemList.size() - 1);
<<<<<<< HEAD
                                    if (systemList.size() - 1 < 0)throw new ShowError(index, row,visualChar).setMessage("多出的']'符号，无法和前面配对");
                                    system = systemList.get(systemList.size() - 1);
                                    shouldState = CODE_V_to_N;
                                } else {
                                    throw new ShowError(index, row,visualChar).setMessage("错误使用']'");
...
<<<<<<< HEAD
                                throw new ShowError(index, row,visualChar).setMessage("不是正确的布尔值false");
=======
...
<<<<<<< HEAD
                                throw new ShowError(index, row,visualChar).setMessage("不是正确的布尔值true");
                            }
                        }
                    } else if(c=='/'&&chars[Math.min(chars.length-1,i+1)]=='*'){
                        isinNotes=2;
                        continue;
                    }else if(c=='/'&&chars[Math.min(chars.length-1,i+1)]=='/'){
                        isinNotes=1;
                        ...
                        throw new ShowError(index, row,visualChar).setMessage("不是正确的数字或布尔值");
=======
